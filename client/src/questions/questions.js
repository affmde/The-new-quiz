...
},
{
    ...
    choices: [{option:'20', id: 1},{option:'30', id: 2},{option:'40', id: 3},{option:'50', id: 4}],
    answer: 4,
},
{
    id:132,
    question: 'Which country do cities of Perth, Adelade & Brisbane belong to?',
    choices: [{option:'Australia', id: 1},{option:'Canada', id: 2},{option:'New Zeeland', id: 3},{option:'Philipines', id: 4}],
    answer: 1,
},
{
    id:133,
    question: 'What is "cynophobia"?',
    choices: [{option:'Fear of rats', id: 1},{option:'Fear of dogs', id: 2},{option:'Fear of cats', id: 3},{option:'Fear of pigs', id: 4}],
    answer: 2,
},
{
    id:134,
    question: 'Which animal can be seen on the Porsche logo?',
    choices: [{option:'Caw', id: 1},{option:'Crocodile', id: 2},{option:'Horse', id: 3},{option:'Lion', id: 4}],
    answer: 3,
},
{
    id:135,
    question: 'What is the name of the largest ocean on earth?',
    choices: [{option:'Atlantic', id: 1},{option:'Indian', id: 2},{option:'Pacific', id: 3},{option:'Arctic', id: 4}],
    answer: 3,
},
{
    id:136,
    question: 'Demolition of the Berlin wall separating East and West Germany began in what year?',
    choices: [{option:'1987', id: 1},{option:'1989', id: 2},{option:'1991', id: 3},{option:'1993', id: 4}],
    answer: 2,
},
{
    id:137,
    question: 'What is the rarest M&M color?',
    choices: [{option:'Brown', id: 1},{option:'White', id: 2},{option:'Yellow', id: 3},{option:'Red', id: 4}],
    answer: 1,
},
{
    id:138,
    question: 'Which country consumes the most chocolate per capita?',
    choices: [{option:'USA', id: 1},{option:'France', id: 2},{option:'Belgium', id: 3},{option:'Switzerland', id: 4}],
    answer: 4,
},
{
    id:139,
    question: 'Which country invented ice cream?',
    choices: [{option:'Portugal', id: 1},{option:'France', id: 2},{option:'Japan', id: 3},{option:'China', id: 4}],
    answer: 4,
},
{
    id:140,
    question: 'From which country does Gouda cheese originate?',
    choices: [{option:'USA', id: 1},{option:'Germany', id: 2},{option:'Netherlands', id: 3},{option:'Switzerland', id: 4}],
    answer: 3,
},
{
    id:141,
    question: 'Which country won the first-ever football World Cup in 1930?',
    choices: [{option:'Uruguay', id: 1},{option:'Argentina', id: 2},{option:'Brazil', id: 3},{option:'England', id: 4}],
    answer: 1,
},
{
    id:142,
    question: 'How many colors are there in the rainbow?',
    choices: [{option:'3', id: 1},{option:'5', id: 2},{option:'7', id: 3},{option:'9', id: 4}],
    answer: 3,
},
{
    id:143,
    question: 'What country touches the Indian Ocean, the Arabian Sea, and the Bay of Bengal?',
    choices: [{option:'India', id: 1},{option:'Nepal', id: 2},{option:'China', id: 3},{option:'Japan', id: 4}],
    answer: 1,
},
{
    id:144,
    question: 'Which country borders 14 nations and crosses 8 time zones?',
    choices: [{option:'USA', id: 1},{option:'Canada', id: 2},{option:'Russia', id: 3},{option:'China', id: 4}],
    answer: 3,
},
{
    id:145,
    question: 'In what country would you find Lake Bled?',
    choices: [{option:'Slovenia', id: 1},{option:'Slovakia', id: 2},{option:'Russia', id: 3},{option:'Germany', id: 4}],
    answer: 1,
},
{
    id:146,
...
},
{
    ...
    choices: [{option:'Irland', id: 1},{option:'Wales', id: 2},{option:'England', id: 3},{option:'Scotland', id: 4}],
    answer: 4,
},
{
    id:148,
    question: 'How long do elephant pregnancies last?',
    choices: [{option:'18 months', id: 1},{option:'20 months', id: 2},{option:'22 months', id: 3},{option:'24 months', id: 4}],
    answer: 3,
},
{
    id:149,
    question: 'What is the nearest planet to the sun?',
    choices: [{option:'Jupiter', id: 1},{option:'Venus', id: 2},{option:'Mercury', id: 3},{option:'Hearth', id: 4}],
    answer: 3,
},
{
    id:150,
    question: 'How many legs does a spider have?',
    choices: [{option:'6', id: 1},{option:'8', id: 2},{option:'10', id: 3},{option:'12', id: 4}],
    answer: 2,
},
{
    id:151,
    question: 'How many Popes were born in Portugal?',
    choices: [{option:'0', id: 1},{option:'1', id: 2},{option:'2', id: 3},{option:'3', id: 4}],
    answer: 2,
},
{
    id:152,
    question: 'Who is the lead singer of the musci band Guns N Roses?',
    choices: [{option:'George Michael', id: 1},{option:'Slash', id: 2},{option:'Bon Jovi', id: 3},{option:'Axl Rose', id: 4}],
    answer: 4,
},
{
    id:153,
    question: 'What album is the most sold in the history of music?',
    choices: [{option:'Back in Black', id: 1},{option:'The Bodyguard', id: 2},{option:'Thriller', id: 3},{option:'Hotel California', id: 4}],
    answer: 3,
},
{
    id:154,
    question: 'Hotel California is a hit from which band?',
    choices: [{option:'Eagles', id: 1},{option:'Red Hot Chili Papers', id: 2},{option:'Metallica', id: 3},{option:'Pink Floyd', id: 4}],
    answer: 1,
},
{
    id:155,
    question: 'Another Brick in the Wall is a hit from which band?',
    choices: [{option:'Eagles', id: 1},{option:'Red Hot Chili Papers', id: 2},{option:'Metallica', id: 3},{option:'Pink Floyd', id: 4}],
    answer: 4,
},
{
    id:156,
    question: 'Whick language is talked in Chile?',
    choices: [{option:'French', id: 1},{option:'English', id: 2},{option:'Spanish', id: 3},{option:'Portuguese', id: 4}],
    answer: 3,
},
{
    id:157,
    question: 'How was known the atomic bomb who distroyed Hiroshima?',
    choices: [{option:'Little Boy', id: 1},{option:'Our Boy', id: 2},{option:'Big Boy', id: 3},{option:'Great Boy', id: 4}],
    answer: 1,
},
{
    id:158,
    question: 'With almost 30 meters high, where can you find the biggest waves in the world?',
    choices: [{option:'Australia', id: 1},{option:'Portugal', id: 2},{option:'USA', id: 3},{option:'Brazil', id: 4}],
    answer: 2,
},
{
    id:159,
    question: 'Who won Ice Hockey gold medal in 2022 Winter Olympic Games?',
    choices: [{option:'Finland', id: 1},{option:'Canada', id: 2},{option:'USA', id: 3},{option:'Russia', id: 4}],
    answer: 1,
},
{
    id:160,
    question: 'Which country does not belong to NATO by 2022?',
    choices: [{option:'Finland', id: 1},{option:'Portugal', id: 2},{option:'Latvia', id: 3},{option:'Iceland', id: 4}],
    answer: 1,
},
]
